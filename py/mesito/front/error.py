...
Usa factory methods to create the errors.
"""
...
ConstraintViolation = TypedDict('ConstraintViolation', {
    'what': str,
    'why': str
})
...
_MachineStateOverlapWhy = TypedDict('_MachineStateOverlapWhy', {
    'start': int,
    'stop': int,
    'machine_id': int
})

MachineStateOverlap = TypedDict('MachineStateOverlap', {
    'what': str,
    'why': _MachineStateOverlapWhy
})


def machine_state_overlap(start: int, stop: int,
                          machine_id: int) -> MachineStateOverlap:
...
def machine_state_condition_changed(old: str,
                                    new: str) -> MachineStateConditionChanged:
...
MachineNotFound = TypedDict('MachineNotFound', {
    'what': str,
